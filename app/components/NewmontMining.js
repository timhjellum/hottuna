    ...
    <>
      ...
      <div className="wrapper">
        <div className="box-2">
          <div className="logo">{/*
<picture>
              <source sizes="250px" srcSet="../assets/images/newmont-mining/logo--large.png 250w" media="(min-width: 1024px)" />
              <source sizes="200px" srcSet="../assets/images/newmont-mining/logo--small.png 200w" media="(min-width: 800px)" />
              <img srcSet="../assets/images/newmont-mining/logo--default.png 150w" alt="" />
            </picture>
*/}</div>
          <div className="text-content">
            <h1 className="title">Newmont Mining</h1>
        ...
        <div className="box-1">{/*
<picture>
            <source sizes="540px" srcSet="../assets/images/newmont-mining/hero--large.jpg 540w" media="(min-width: 1200px)" />
            <source sizes="470px" srcSet="../assets/images/newmont-mining/hero--medium.jpg 470w" media="(min-width: 1024px)" />
            <source sizes="360px" srcSet="../assets/images/newmont-mining/hero--small.jpg 360w" media="(min-width: 800px)" />
            <img srcSet="../assets/images/newmont-mining/hero--default.jpg 320w" alt="" />
          </picture>
*/}</div>
      </div>
    </>
