    ...
    <>
      ...
      <div className="wrapper">
        <div className="box-2">
          <div className="logo">{/*
<picture>
              <source sizes="250px" srcSet="../assets/images/wyoming-workforce-services/logo--large.png 250w" media="(min-width: 1024px)" />
              <source sizes="200px" srcSet="../assets/images/wyoming-workforce-services/logo--small.png 200w" media="(min-width: 800px)" />
              <img srcSet="../assets/images/wyoming-workforce-services/logo--default.png 150w" alt="" />
            </picture>
*/}</div>
          <div className="text-content">
            <h1 className="title">Wyoming Workforce Services</h1>
            <h2 className="subtitle">
              <a href="http://www.wyomingworkforce.org/">wyomingworkforce.org</a>
            </h2>
        ...
        <div className="box-1">{/*
<picture>
            <source sizes="540px" srcSet="../assets/images/wyoming-workforce-services/hero--large.jpg 540w" media="(min-width: 1200px)" />
            <source sizes="470px" srcSet="../assets/images/wyoming-workforce-services/hero--medium.jpg 470w" media="(min-width: 1024px)" />
            <source sizes="360px" srcSet="../assets/images/wyoming-workforce-services/hero--small.jpg 360w" media="(min-width: 800px)" />
            <img srcSet="../assets/images/wyoming-workforce-services/hero--default.jpg 320w" alt="" />
          </picture>
*/}</div>
      </div>
    </>
